...
//
//public abstract class RaceTrackSuper
//{
...
//	raceTrackObjects = new ArrayList<>();
//	listener = new ArrayList<>();
//	//	borderCollisionHandler = new BorderCollisionHandler();
...
//		break;
//	    case "Concreteblock":
//		//		car.direction(-4 * car.getSpeed());
//		//		car.slowDown();
//		//		car.setPrevCoords();
//		//		car.direction(-5 * move.direction);
//		//		car.turn((move.direction - 5));
//
//		car.slowDown();
//		car.setPrevCoords();
...
//	final int[] check1 = new int[] { 1700, 600, 20, 20, 1 };
//	final int[] check2 = new int[] { 900, 900, 20, 20, 2 };
//	final int[] check3 = new int[] { 200, 600, 20, 20, 3 };
//	final int[] check4 = new int[] { 900, 200, 20, 20, 4 };
//
//	final int[] oil1 = new int[] { 1700, 400, 20, 20 };
//	final int[] conBlock = new int[] { 400, 250, 80, 80 };
//
...
//	obstacle.add(new ConcreteBlock(conBlock));
//    }
//
...
//	    if (i == 1) {
//		final int[] car1Coords = new int[] { 300, 200 };
//		carList.add(new Car(Color.red, car1Coords));
//	    } else if (i == 2) {
//		final int[] car2Coords = new int[] { 130, 130 };
...
//    }
//
//    protected void setSquareType(int col, int row, SquareTypes sq){
//	squareType[col][row] = sq;
//    }
//}
